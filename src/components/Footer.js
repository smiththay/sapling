...
export default function Footer() {
    return (
        <div>
        <div className="footer container-fluid pt-5 justify-content-center text-light ">
                <footer>
                    <div className="row my-5 justify-content-center py-5 bg-secondary">
                        <div className="col-11">
                            <div className="row ">
                                <div className="col-xl-8 col-md-4 col-sm-4 col-12 my-auto mx-auto a">
                                    <img src="./SAPLING.png" className="w-25" alt="logo" />
                                </div>
                            ...
                            <div className="row ">
                                <div className="col-xl-8 col-md-4 col-sm-4 col-auto my-md-0 mt-5 order-sm-1 order-3 align-self-end">
                                    <p className="social  mb-0 pb-0 bold-text">
                                        {/* <span className="mx-2"><a href='https://www.linkedin.com/in/smiththay/' target='_blank' style={{color: 'white'}}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-instagram" viewBox="0 0 16 16">
                                        ...
                                        {/* <span className="mx-2"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-slack" viewBox="0 0 16 16">
                                    ...
                                    <small className="rights"><span>&#174;</span> Sapling All Rights Reserved.</small>
                                </div>
