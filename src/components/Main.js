                ...
                <div className="row bg-light">
                    <div className="row mt-5 mb-5 ">
                        <div className="col-md-6 col-sm-12">
                            <img src="./investing.png" className="card-img-top img-fluid mt-25" alt="investing" />
                        </div>
                        <div className="col-md-6 col-sm-12 mt-5 pt-5 mb-5">

                            <h1 className='text-center'><i>Anything is possible...</i></h1>
                            <br />
                ...
                <div className="col-sm-6">
                    <div className="card-spon mx-5">
                        <div className="card-body">
                            ...
                            <p className="card-text">Saving for a trip, and need some help planning?</p>
                            <a href="https://awesome-vacation-planner.web.app/" target="_blank" className="btn btn-warning">TripShare</a>
                        </div>
                    </div>
                </div>
                <div className="col-sm-6">
                    <div className="card-spon mx-5">
                        <div className="card-body">
                            ...
                            <p className="card-text">Built that emergency fund now you want to learn to invest?</p>
                            <a href="https://yolofund.reecewalter.com/" target="_blank" className="btn btn-warning">Yolo Fund</a>
                        </div>
                    </div>
                </div>
            </div>
